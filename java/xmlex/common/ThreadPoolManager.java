...
public class ThreadPoolManager {
    ...
    private ThreadPoolManager() {
        _generalScheduledThreadPool = new ScheduledThreadPoolExecutor(4, new PriorityThreadFactory(
    ...
    public String[] getStats() {
        return new String[]{
				...
				" │ ScheduledTasks:  "
						+ (_moveScheduledThreadPool.getTaskCount() - _moveScheduledThreadPool
								.getCompletedTaskCount()),
				" ╞══ Pathfind:",
				...
				" │ ScheduledTasks:  "
						+ (_pathfindThreadPool.getTaskCount() - _pathfindThreadPool
								.getCompletedTaskCount()),
				" ╞══ Npc AI:",
				...
				" │ ScheduledTasks:  "
						+ (_npcAiScheduledThreadPool.getTaskCount() - _npcAiScheduledThreadPool
								.getCompletedTaskCount()),
				" ╞══ Player AI:",
				...
				" │ ScheduledTasks:  "
						+ (_playerAiScheduledThreadPool.getTaskCount() - _playerAiScheduledThreadPool
								.getCompletedTaskCount()),*/
                /*
                ...
                " ╞══ IO Packets:", " │ ActiveThreads:   " + _ioPacketsThreadPool.getActiveCount(),
				...
				" ╞══ LS/GS Packets:", " │ ActiveThreads:   " + _LsGsExecutor.getActiveCount(),

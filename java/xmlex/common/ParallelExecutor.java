...
public class ParallelExecutor {
    ...
    public ParallelExecutor(String name, int prio, int cores) {
        executor = new ThreadPoolExecutor(cores, cores, 1, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(),
                new PriorityThreadFactory(name, prio));
    }
    ...
    public void execute(Object obj, Class<?> clazz, String methodName, Object... args) throws SecurityException,
            NoSuchMethodException {
        execute(TaskCreator.createTask(obj, clazz, methodName, args));
    }

    public void execute(Object obj, String className, String methodName, Object... args) throws SecurityException,

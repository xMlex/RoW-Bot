...
public abstract class mysql {
    ...
    public static ArrayList<Integer> get_int_array(String ret_field, String table, String where) {
        String query = "SELECT `" + ret_field + "` FROM `" + table + "` " + where;
    ...
    public static Integer[][] simple_get_int_array(L2DatabaseFactory db, String[] ret_fields, String table,
                                                   String where) {

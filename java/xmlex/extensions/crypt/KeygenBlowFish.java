 ...
 */
public class KeygenBlowFish {
    private static final Logger _log = Logger.getLogger(KeygenBlowFish.class.getName());
    private static final int CRYPT_KEYS_SIZE = 5;
    ...
    public static void generate() {
        ...
        _log.info("Cached " + CRYPT_KEYS.length + " Keys for BlowFish communication");
    }

...
public class PyroByteSinkFeeder extends PyroClientAdapter {
    private final jawnae.pyronet.PyroSelector selector;
    private final ByteBuffer buf;
    private final ByteStream inbound;
    private final LinkedList<ByteSink> sinks;

    public PyroByteSinkFeeder(jawnae.pyronet.PyroClient client) {
        this(client.selector());
    }

    public PyroByteSinkFeeder(jawnae.pyronet.PyroSelector selector) {
        this(selector, 8 * 1024);
    }

    public PyroByteSinkFeeder(jawnae.pyronet.PyroSelector selector, int bufferSize) {

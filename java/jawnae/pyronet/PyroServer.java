...
public class PyroServer implements Iterable<PyroClient> {
    ...
    PyroServer(PyroSelector selector, Selector nioSelector, InetSocketAddress endpoint, int backlog) throws IOException {
    ...
    private void onReadyToAccept() throws IOException {
        ...
        if (acceptedClientSelector == this.selector) {
            ...
            PyroClient client = new PyroClient(acceptedClientSelector, this, clientKey);
            ...
            acceptedClientSelector.scheduleTask(new Runnable() {
                ...
                public void run() {
                    ...
                    final PyroClient client = new PyroClient(acceptedClientSelector, PyroServer.this, clientKey);

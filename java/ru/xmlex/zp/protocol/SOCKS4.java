...
public class SOCKS4 extends PyroLazyBastardAdapter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length < 2 || args.length > 3) {
            System.out.println("Usage: {hostname} {port} [{threadCount}]");
            // System.exit(0);
            host = "127.0.0.1";
            port = 1080;
            count_thread = 4;
            ...
            count_thread = Integer.parseInt(args[2]);
            if (count_thread < 1)
        ...
        PyroSelector[] pool = new PyroSelector[count_thread];
        ...
        System.out.println("Run SOCKS4 server(core: " + pool.length + "): "
                + server);
    }
    ...
    public void connectedClient(PyroClient dst) {
        ...
        attachment.target.removeListeners();
        dst.removeListeners();
        attachment.listener.setServer(dst);
        attachment.listener.setClient(attachment.target);
    }
    ...
    public void receivedData(PyroClient client, ByteBuffer data) {
        ...
        if (attachment.header != null) {
            ...
            attachment.listener.recvData(data, attachment.target);
    ...
    static class SocksAttachment {
        ...
        public SOCKS4Listener listener = new SOCKS4Listener();
    ...
    static class SocksRedirectRequest {
        ...
        public byte[] userid;
        public SOCKS4Listener _listener = new SOCKS4Listener();
        ...
        public void handshake(PyroClientListener listener) {
            ...
            try {
                ...
                // SLOW!
                InetSocketAddress connect = new InetSocketAddress(iaddr,
                        this.port);

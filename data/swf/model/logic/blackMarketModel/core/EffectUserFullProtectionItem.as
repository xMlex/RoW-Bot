...
import model.logic.blackMarketModel.applyBehaviours.EffectUserFullProtectionApplyBehaviour;
...
public class EffectUserFullProtectionItem extends BlackMarketItemBase {


    public var timeSeconds:Number;

    public function EffectUserFullProtectionItem() {
        super();
    }
    ...
    override protected function createApplyBehaviour():IApplyBehaviour {
        return new EffectUserFullProtectionApplyBehaviour();
    }

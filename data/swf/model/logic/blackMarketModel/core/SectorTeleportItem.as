...
import model.logic.blackMarketModel.applyBehaviours.MoveSectorItemApplyBehaviour;
...
public class SectorTeleportItem extends BlackMarketItemBase {


    public var random:Boolean;

    public function SectorTeleportItem() {
        super();
    }
    ...
    override protected function createApplyBehaviour():IApplyBehaviour {
        return new MoveSectorItemApplyBehaviour();
    }

...
public class EffectUserDefencePowerItemCount extends BlackMarketItemCount {


    private const FIRST_TYPE_ID:int = BlackMarketUnionTypeIds.GAIN_DEFENCE_10P_4H_CRYSTAL;

    private const SECOND_TYPE_ID:int = BlackMarketUnionTypeIds.GAIN_DEFENCE_10P_4H_BLACK_CRYSTAL;

    public function EffectUserDefencePowerItemCount(param1:int) {
        super(param1);
    }

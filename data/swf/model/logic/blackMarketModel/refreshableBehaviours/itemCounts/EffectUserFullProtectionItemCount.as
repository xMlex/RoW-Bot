...
public class EffectUserFullProtectionItemCount extends BlackMarketItemCount {


    private const FIRST_TYPE_ID:int = BlackMarketUnionTypeIds.FULL_PROTECTION_8H_CRYSTAL;

    private const SECOND_TYPE_ID:int = BlackMarketUnionTypeIds.FULL_PROTECTION_8H_BLACK_CRYSTAL;

    public function EffectUserFullProtectionItemCount(param1:int) {
        super(param1);
    }

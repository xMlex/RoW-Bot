...
public class ChestItemDiscountContext extends DiscountContextBase {


    private var _itemId:int;

    public function ChestItemDiscountContext(param1:int) {
        super();
        this._itemId = param1;
    }
    ...
    override public function refresh():void {
        ...
        _loc1_ = StaticDiscountManager.chestsDiscount;

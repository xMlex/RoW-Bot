...
public class EffectTroopsTierBattleExperienceInfantryBuilder implements IBlackMarketItemBuilder {

    private static const HOUR_IN_SECONDS:int = 60 * 60;


    public function EffectTroopsTierBattleExperienceInfantryBuilder() {
        super();
    }
    ...
    protected function fillLocaleData(param1:BattleExperienceIncreaserItem):void {
        param1.name = LocaleUtil.getText("forms-blackMarketItems_effectTroopsTierBattleExperienceInfantry_name") + " +" + param1.power + "%";
        param1.description = LocaleUtil.getText("forms-blackMarketItems_effectTroopsTierBattleExperienceInfantry_description") + " " + buildDuration(param1.timeSeconds);
        param1.descriptionWithoutDuration = LocaleUtil.getText("forms-formPromotionOffers_tierBattleExperienceInfantryDescription");
        param1.fullName = param1.name;
        param1.helpText = LocaleUtil.getText("forms-blackMarketItems_effectTroopsTierBattleExperienceInfantry_helpText");
    }
    ...
    public function build(param1:BlackMarketItemRaw):BlackMarketItemBase {
        ...
        _loc2_.troopsGroupId = TroopsGroupId.INFANTRY;

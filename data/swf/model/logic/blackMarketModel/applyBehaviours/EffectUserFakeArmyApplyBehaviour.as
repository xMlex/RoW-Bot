...
public class EffectUserFakeArmyApplyBehaviour extends ApplyBehaviourBase {


    private const FIRST_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.FAKE_ARMY_8H_CRYSTAL;

    private const SECOND_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.FAKE_ARMY_8H_BLACK_CRYSTAL;

    private var _commandCache:ActivateEffectItemCmd;

    private var _itemId:int;

    public function EffectUserFakeArmyApplyBehaviour() {
        super();
    }

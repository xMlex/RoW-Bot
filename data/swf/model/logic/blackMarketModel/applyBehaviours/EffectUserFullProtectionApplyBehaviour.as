...
public class EffectUserFullProtectionApplyBehaviour extends ApplyBehaviourBase {


    private const FIRST_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.FULL_PROTECTION_8H_CRYSTAL;

    private const SECOND_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.FULL_PROTECTION_8H_BLACK_CRYSTAL;

    private var _commandCache:ActivateEffectItemCmd;

    private var _itemId:int;

    public function EffectUserFullProtectionApplyBehaviour() {
        super();
    }

...
public class UserAutoMoveTroopsBunkerApplyBehaviour extends ApplyBehaviourBase {


    private const FIRST_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.AUTOHIDE_4H_CRYSTAL;

    private const SECOND_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.AUTOHIDE_4H_BLACK_CRYSTAL;

    private var _commandCache:ActivateEffectItemCmd;

    private var _itemId:int;

    public function UserAutoMoveTroopsBunkerApplyBehaviour() {
        super();
    }

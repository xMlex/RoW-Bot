...
public class EffectSectorDefensePowerBonusApplyBehaviour extends ApplyBehaviourBase {


    private const FIRST_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.SECTOR_DEFENCE_POWER_BONUS_4H_CRYSTAL;

    private const SECOND_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.SECTOR_DEFENCE_POWER_BONUS_4H_BLACK_CRYSTAL;

    private var _commandCache:ActivateEffectItemCmd;

    private var _itemId:int;

    public function EffectSectorDefensePowerBonusApplyBehaviour() {
        super();
    }

...
public class EffectDynamicMinesBonusMiningApplyBehaviour extends ApplyBehaviourBase {


    private const FIRST_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.DYNAMIC_MINES_BONUS_MINING_25P_CRYSTAL;

    private const SECOND_UNION_TYPE_ID:int = BlackMarketUnionTypeIds.DYNAMIC_MINES_BONUS_MINING_25P_BLACK_CRYSTAL;

    private var _commandCache:ActivateEffectItemCmd;

    private var _itemId:int;

    public function EffectDynamicMinesBonusMiningApplyBehaviour() {
        super();
    }

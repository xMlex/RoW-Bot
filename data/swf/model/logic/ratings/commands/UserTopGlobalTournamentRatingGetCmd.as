...
public class UserTopGlobalTournamentRatingGetCmd extends BaseCmd {


    private var _tournamentPrototypeId:int;

    public function UserTopGlobalTournamentRatingGetCmd(param1:int) {
        super();
        this._tournamentPrototypeId = param1;
    }

    override public function execute():void {
        new JsonCallCmd("Rating.GetUserInTournamentRating", this._tournamentPrototypeId, "POST").ifResult(function (param1:*):void {

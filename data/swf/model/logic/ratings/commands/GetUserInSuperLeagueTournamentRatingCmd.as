...
public class GetUserInSuperLeagueTournamentRatingCmd extends BaseCmd {


    private var _tournamentPrototypeId:int;

    public function GetUserInSuperLeagueTournamentRatingCmd(param1:int) {
        super();
        this._tournamentPrototypeId = param1;
    }

    override public function execute():void {
        new JsonCallCmd("Rating.GetUserInSuperLeagueTournamentRating", this._tournamentPrototypeId, "POST").ifResult(function (param1:*):void {

...
public class AllianceInTournamentRatingGetCmd extends BaseCmd {


    private var _requestDto;

    public function AllianceInTournamentRatingGetCmd(param1:int, param2:int) {
        super();
        this._requestDto = {
            "i": param1,
            "a": param2
    ...
    override public function execute():void {
        new JsonCallCmd("Rating.GetAllianceInTournamentRating", this._requestDto, "POST").ifResult(function (param1:*):void {

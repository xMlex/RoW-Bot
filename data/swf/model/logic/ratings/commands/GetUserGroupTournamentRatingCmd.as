...
public class GetUserGroupTournamentRatingCmd extends BaseCmd {


    private var _requestDto;

    public function GetUserGroupTournamentRatingCmd(param1:int, param2:int, param3:int, param4:int) {
        super();
        this._requestDto = {
            "l": param2,
            "c": param1,
    ...
    override public function execute():void {
        new JsonCallCmd("Rating.GetUserGroupsTournamentRating", this._requestDto, "POST").ifResult(function (param1:*):void {

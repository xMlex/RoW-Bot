...
public class RatingGlobalMissionGetCmd extends BaseCmd {


    private var requestDto;

    public function RatingGlobalMissionGetCmd(param1:int, param2:int = 1, param3:int = -1) {
        super();
        this.requestDto = {
            "l": param2,
            "c": param1
    ...
    override public function execute():void {
        new JsonCallCmd("Rating.GetGlobalMissionRating", this.requestDto, "POST").ifResult(function (param1:*):void {

...
public class GetSuperLeagueTournamentRatingCmd extends BaseCmd {


    private var _requestDto;

    public function GetSuperLeagueTournamentRatingCmd(param1:int, param2:int) {
        super();
        this._requestDto = {
            "c": param1,
            "i": param2
    ...
    override public function execute():void {
        new JsonCallCmd("Rating.GetSuperLeagueTournamentRating", this._requestDto, "POST").ifResult(function (param1:*):void {

...
public class AllianceUsersTournamentRatingGetCmd extends BaseCmd {


    private var _requestDto;

    public function AllianceUsersTournamentRatingGetCmd(param1:int, param2:int, param3:int) {
        super();
        this._requestDto = {
            "c": param3,
            "i": param1,
    ...
    override public function execute():void {
        new JsonCallCmd("Rating.GetAllianceUsersTournamentRating", this._requestDto, "POST").ifResult(function (param1:*):void {

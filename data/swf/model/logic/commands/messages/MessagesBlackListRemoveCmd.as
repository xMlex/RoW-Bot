...
public class MessagesBlackListRemoveCmd extends BaseCmd {
    ...
    public function MessagesBlackListRemoveCmd(param1:Number) {
        super();
        this._userId = param1;
    ...
    override public function execute():void {
        new JsonCallCmd("Messages.BlackListRemove", this.requestDto, "POST").ifResult(function (param1:*):void {

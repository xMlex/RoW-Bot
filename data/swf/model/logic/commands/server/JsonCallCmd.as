...
public class JsonCallCmd extends BaseCmd {

    private static const CLASS_NAME:String = "JsonCallCommand";
    ...
    private static var _isHiddenMode:String;
    ...
    public function JsonCallCmd(param1:String, param2:*, param3:String = "POST", param4:String = "") {
        super();
    ...
    private static function makeUrl(param1:String):String {
        var _loc2_:* = param1 + "/segment.ashx";
        if (param1.indexOf("https://") == -1 && param1.indexOf("http://") == -1) {
            _loc2_ = "http://" + param1 + "/segment.ashx";
        }
        return _loc2_;
    }
    ...
    public static function setHiddenMode(param1:String):void {
        _isHiddenMode = param1;
    }

    public static function getHiddenMode():Boolean {
        return _isHiddenMode == "true";
    }
    ...
    private static function generateRequestSignature(param1:String, param2:String):String {
        var _loc3_:String = !!GameType.isNords ? "D1738B9DB08344CB9E0104DAC7C7867D" : "The Matrix has you...";
        var _loc4_:String = _loc3_ + param1 + param2;
        var _loc5_:String = MD5.hash(_loc4_);
        return _loc5_;
    }

    public function setSegment(param1:int):JsonCallCmd {
        return this.setAddress(ServerManager.SegmentServerAddresses[param1]);
    }

    public function setAddress(param1:String):JsonCallCmd {
        this._url = makeUrl(param1);
        return this;
    }

    public function noResponseSignature():JsonCallCmd {
    ...
    private function call(param1:Boolean, param2:String, param3:String, param4:Function = null, param5:Function = null):void {
        ...
        try {
            ...
            this._loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, faultFunction);
            ...
            if (httpPost) {
                ...
                headers.push(new URLRequestHeader("client-type", ServerManager.clientType));
                ...
                if (_isHiddenMode != null && _isHiddenMode != "") {
                    headers.push(new URLRequestHeader("hidden-mode", _isHiddenMode));
                }
                if (_userSocialId != null && _userSocialId != "") {

...
public class UpgradeGemCmd extends BaseCmd {


    private var _dto;

    public function UpgradeGemCmd(param1:Array) {
        super();
        this._dto = UserRefreshCmd.makeRequestDto({"g": param1});
    }

    override public function execute():void {
        new JsonCallCmd("UpgradeGem", this._dto, "POST").ifResult(function (param1:*):void {

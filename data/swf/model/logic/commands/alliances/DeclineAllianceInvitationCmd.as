...
public class DeclineAllianceInvitationCmd extends BaseCmd {
    ...
    public function DeclineAllianceInvitationCmd(param1:UserAllianceInvitation) {
        super();
    ...
    override public function execute():void {
        new JsonCallCmd("Alliance.DeclineInvitation", this.requestDto, "POST").ifResult(function (param1:*):void {
            var _loc2_:* = undefined;
            if (!UserRefreshCmd.updateUserByResultDto(param1, requestDto)) {
                _loc2_ = UserManager.user.gameData.allianceData;
                _loc2_.removeInvitation(_invitation);
                _loc2_.dirty = true;
            }
            if (_onResult != null) {
                _onResult();
